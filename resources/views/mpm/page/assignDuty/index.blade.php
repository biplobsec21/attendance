...
@section('title', 'Assigned Duty List')

@section('content')
<div class="container mx-auto p-4">
    <div class="bg-white/30 shadow-lg rounded-lg p-4 sm:p-6 formBack">
        <div class="flex flex-col md:flex-row justify-between items-center mb-4 gap-4">
            <h1 class="text-2xl font-bold text-gray-800">Assigned Duty List</h1>
            <div class="w-full md:w-auto flex flex-col sm:flex-row items-center gap-2">
                ...
                <a href="{{ url('asignDuty/create') }}" class="w-full sm:w-auto bg-transparent text-black font-semibold py-2 px-4 border border-black rounded-lg hover:bg-black hover:text-white transition-colors text-center no-underline">Assign New Duty</a>
            </div>
        </div>
...
<script>
    // --- Assigned Duty Data ---
    const assignedDutyData = [
        { sl: 1, date: "2023-10-01", no: "12345", rank: "Captain", person: "John Doe", duty: "Guard Duty", startTime: "22:00", endTime: "06:00", remark: "Night shift", status: "Approved" },
        { sl: 2, date: "2023-10-01", no: "54321", rank: "Major", person: "Jane Smith", duty: "Kitchen Patrol", startTime: "08:00", endTime: "16:00", remark: "Morning shift", status: "Waiting" },
        { sl: 3, date: "2023-10-02", no: "67890", rank: "Sergeant", person: "Peter Jones", duty: "Cleaning Duty", startTime: "09:00", endTime: "17:00", remark: "", status: "Rejected" },
        { sl: 4, date: "2023-10-03", no: "12345", rank: "Captain", person: "John Doe", duty: "Guard Duty", startTime: "14:00", endTime: "22:00", remark: "Day shift", status: "Approved" },
        { sl: 5, date: "2023-10-03", no: "09876", rank: "Lieutenant", person: "Mary Williams", duty: "Kitchen Patrol", startTime: "16:00", endTime: "24:00", remark: "Evening shift", status: "Waiting" }
    ];
    ...
    let currentPage = 1;
    let rowsPerPage = rowsPerPageSelect.value === 'all' ? assignedDutyData.length : parseInt(rowsPerPageSelect.value);
    let filteredData = [...assignedDutyData];
    ...
    searchInput.addEventListener('keyup', (e) => {
        ...
        filteredData = assignedDutyData.filter(item => {
    ...
    rowsPerPageSelect.addEventListener('change', (e) => {
        ...
        if (selectedValue === 'all') {
            rowsPerPage = filteredData.length > 0 ? filteredData.length : assignedDutyData.length;
        } else {
