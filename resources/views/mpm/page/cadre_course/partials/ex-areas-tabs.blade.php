                ...
                <thead class="bg-gray-50">
                    <tr>
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                            <input type="checkbox" id="selectAllExAreas" class="form-checkbox h-4 w-4 text-indigo-600">
                        </th>
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                            #
                        </th>
                    ...
                    @forelse($currentExAreas as $index => $assignment)
                        <tr class="hover:bg-gray-50 transition-colors duration-200 searchable-row">
                            <td class="px-6 py-4 whitespace-nowrap">
                                <input type="checkbox" class="ex-area-checkbox form-checkbox h-4 w-4 text-indigo-600"
