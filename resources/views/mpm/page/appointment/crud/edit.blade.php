...
@section('content')
    <div class="container mx-auto p-4">
        ...
        <div class="bg-white/30 shadow-lg rounded-lg p-6 formBack w-full max-w-lg mx-auto">
            <h1 class="text-2xl font-bold mb-6 text-center text-gray-800">Edit appointment</h1>
            ...
            <form method="POST" action="{{ route('appointments.update', $appointment) }}"
                ...
                <div class="mb-6">
                    ...
                    <select id="status" name="status"
                        ...
                        <option value="1"
                            {{ old('status', (string) (int) $appointment->status) === '1' ? 'selected' : '' }}>
                            Active</option>
                        <option value="0"
                            {{ old('status', (string) (int) $appointment->status) === '0' ? 'selected' : '' }}>
                            Inactive</option>
