...
@section('title', 'Create Medical Category')
...
@section('content')
    <div class="container mx-auto p-4">
        ...
        <div class="bg-white/30 shadow-lg rounded-lg p-6 formBack w-full max-w-lg mx-auto">
            <h1 class="text-2xl font-bold mb-6 text-center text-gray-800">Create New Medical Category</h1>

            <form method="POST" action="{{ route('medical-categories.store') }}"
