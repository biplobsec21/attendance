...
@section('content')
    <div class="container mx-auto p-4">
        ...
        <div class="bg-white/30 shadow-lg rounded-lg p-6 formBack w-full max-w-lg mx-auto">
            <h1 class="text-2xl font-bold mb-6 text-center text-gray-800">Edit Medical Category</h1>

            <form method="POST" action="{{ route('medical-categories.update', $medicalCategory) }}"
                ...
                <div class="mb-6">
                    <label for="name" class="block text-gray-700 text-sm font-bold mb-2">
                        Medical Category Name <span class="text-red-600">*</span>
                    </label>
                    <input type="text" id="name" name="name" value="{{ old('name', $medicalCategory->name) }}"
                        ...
                        placeholder="Enter medical category name" required maxlength="350">
                    @error('name')
