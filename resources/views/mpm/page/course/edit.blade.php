...
@section('content')
    <div class="container mx-auto p-4">
        ...
        <div class="bg-white/30 shadow-lg rounded-lg p-6 formBack w-full max-w-lg mx-auto">
            <h1 class="text-2xl font-bold mb-6 text-center text-gray-800">Edit Course</h1>
            ...
            <form method="POST" action="{{ route('courses.update', $course) }}"
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="category" name="category" value="{{ old('category', $course->category) }}"
                        class="shadow-sm appearance-none border rounded-lg w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-2 focus:ring-orange-500 @error('category') border-red-500 @enderror"
                ...
                <div class="mb-4">
                    ...
                    <textarea id="description" name="description"
                        class="shadow-sm border rounded-lg w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-2 focus:ring-orange-500 @error('description') border-red-500 @enderror"
                ...
                <div class="mb-6">
                    ...
                    <select id="status" name="status"
                        ...
                        <option value="1"
                            {{ old('status', (string) (int) $course->status) === '1' ? 'selected' : '' }}>Active</option>
                        <option value="0"
                            {{ old('status', (string) (int) $course->status) === '0' ? 'selected' : '' }}>Inactive</option>
