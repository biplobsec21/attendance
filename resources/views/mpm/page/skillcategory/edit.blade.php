...
@section('title', 'Edit skillcategory')
...
@section('content')
    <div class="container mx-auto p-4">
        ...
        <div class="bg-white/30 shadow-lg rounded-lg p-6 formBack w-full max-w-lg mx-auto">
            ...
            <form method="POST" action="{{ route('skillcategory.update', $skillcategory) }}"
                ...
                <div class="mb-4">
                    <label for="name" class="block text-gray-700 text-sm font-bold mb-2">
                        skillcategory Name <span class="text-red-600">*</span>
                    </label>
                    <input type="text" id="name" name="name" value="{{ old('name', $skillcategory->name) }}"
                        ...
                        placeholder="Enter skillcategory name" required>
                    @error('name')
                ...
                <div class="mb-6">
                    ...
                    <select id="status" name="status"
                        ...
                        <option value="1"
                            {{ old('status', (string) (int) $skillcategory->status) === '1' ? 'selected' : '' }}>
                            Active</option>
                        <option value="0"
                            {{ old('status', (string) (int) $skillcategory->status) === '0' ? 'selected' : '' }}>
                            Inactive</option>
