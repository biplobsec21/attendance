        ...
        <div class="bg-white border rounded-lg p-8">
            <form>
                <div class="grid grid-cols-12 gap-8 pb-8">
                    <div class="col-span-12 md:col-span-4"><label class="font-bold text-gray-700">Medical
                            Category</label>
                        <p class="text-sm text-gray-500 mt-1">Add your current or past medical categories.</p>
                    </div>
                    <div class="col-span-12 md:col-span-8">
                        <div id="medical-container" class="space-y-4"></div><button type="button" id="add-medical"
                ...
                <div class="grid grid-cols-12 gap-8 border-t pt-8 pb-8">
                    <div class="col-span-12 md:col-span-4"><label class="font-bold text-gray-700">Permanent
                            Sickness</label>
                        <p class="text-sm text-gray-500 mt-1">List any permanent sickness if applicable.</p>
                    </div>
                    <div class="col-span-12 md:col-span-8">
                        <div id="sickness-container" class="space-y-4"></div><button type="button" id="add-sickness"
                            class="add-btn mt-4 bg-gray-200 hover:bg-gray-300 text-gray-700 font-semibold py-2 px-4 rounded-lg text-sm">+
                            Add Sickness</button>
                    </div>
                </div>
                <div class="grid grid-cols-12 gap-8 border-t pt-8">
                    <div class="col-span-12 md:col-span-4"><label class="font-bold text-gray-700">Disciplinary
                            Records</label>
                        <p class="text-sm text-gray-500 mt-1">Mention any good behavior awards and list any
                            punishments.</p>
                    </div>
                    <div class="col-span-12 md:col-span-8">
                        <div><label for="good-behave" class="block text-sm font-medium text-gray-600 mb-1">Good
                                Behavior</label><input type="text" id="good-behave"
                                placeholder="e.g., Commendation for good service" class="w-full p-2 border rounded-md">
                        </div>
                        <div class="mt-6">
                            <label class="block text-sm font-medium text-gray-600 mb-1">Punishments</label>
                            <div id="punishments-container" class="space-y-4"></div>
