...
@section('content')
    <div class="container mx-auto p-4">
        <div class="bg-white/30 shadow-lg rounded-lg p-6 formBack w-full max-w-lg mx-auto">
            <h1 class="text-2xl font-bold mb-6 text-center text-gray-800">Edit skill</h1>
            ...
            <form method="POST" action="{{ route('skill.update', $skill) }}"
                ...
                <div class="mb-4">
                    <label for="name" class="block text-gray-700 text-sm font-bold mb-2">
                        skill Name <span class="text-red-600">*</span>
                    </label>
                ...
                <div class="mb-4">
                    <label for="category_id" class="block text-gray-700 text-sm font-bold mb-2">
                        Skill Category <span class="text-red-600">*</span>
                    </label>
                ...
                <div class="mb-6">
                    ...
                    <select id="status" name="status"
                        ...
                        <option value="1" {{ old('status', (string) (int) $skill->status) === '1' ? 'selected' : '' }}>
                            Active</option>
                        <option value="0" {{ old('status', (string) (int) $skill->status) === '0' ? 'selected' : '' }}>
                            Inactive</option>
