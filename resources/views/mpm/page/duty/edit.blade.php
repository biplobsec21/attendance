        ...
        <div class="container mx-auto max-w-4xl">
            ...
            <div class="mb-6">
                <div class="flex items-center gap-3 p-3 bg-white/50 rounded-xl border border-gray-200">
                    ...
                    <div>
                        <h1 class="text-xl font-bold text-gray-900">Edit Duty Record</h1>
                        <p class="text-sm text-gray-500">Update the details for this duty assignment</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white/80 backdrop-blur-sm shadow-xl rounded-3xl border border-white/50 overflow-hidden">
                <div class="p-8">
                    <form method="POST" action="{{ route('duty.update', $duty->id) }}" id="duty-form">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="space-y-8">
                            ...
                            <div class="group">
                                ...
                                <div class="relative">
                                    <input type="text" id="duty-name" name="duty_name"
                                        value="{{ old('duty_name', $duty->duty_name) }}"
                            ...
                            <div class="group">
                                        ...
                                        <div class="relative">
                                            <select id="duration-days" name="duration_days"
                                                ...
                                                @for ($days = 1; $days <= 30; $days++)
                                                    @php
                                                        $selected =
                                                            old('duration_days', $duty->duration_days) == $days
                                                                ? 'selected'
                                                                : '';
                                ...
                                {{-- Duration Display --}}
                                <div id="duration-display" class="bg-blue-50 border border-blue-200 rounded-lg p-4">
                                    <div class="flex items-center justify-between">
                                        <div>
                                            <span class="text-sm font-medium text-blue-800">Duty Schedule:</span>
                                            <span id="schedule-display"
                                                class="text-lg font-bold text-blue-600 ml-2">{{ $scheduleDescription }}</span>
                                        </div>
                                        @if ($duty->duration_days > 1)
                                            <div id="multi-day-indicator">
                                                <span
                                    ...
                                    <div class="mt-2 grid grid-cols-2 gap-4 text-sm">
                                        ...
                                        <div>
                                            ...
                                            <span id="total-duration" class="ml-2">{{ $totalHours }} hours</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="group">
                                <div class="flex items-center justify-between mb-4">
                                    ...
                                    <div class="text-sm text-gray-600 bg-blue-50 px-3 py-1 rounded-lg">
                                        Total Manpower: <span id="total-manpower-display"
                                            class="font-bold text-blue-600">{{ $duty->manpower }}</span>
                                    </div>
                                </div>
                                ...
                                <input type="hidden" id="total-manpower" name="manpower"
                                    value="{{ $duty->manpower }}">
                            </div>
                            ...
                            <div class="group">
                                ...
                                <div class="relative">
                                    <textarea id="remark" name="remark" rows="4"
                                        ...
                                        placeholder="Enter any remarks or additional information...">{{ old('remark', $duty->remark) }}</textarea>
                            ...
                            <div class="group">
                                ...
                                <div class="relative">
                                    <select id="status" name="status"
                                        ...
                                        required>
                                        <option value="Active" @if (old('status', $duty->status) == 'Active') selected @endif>
                                            🟢 Active
                                        </option>
                                        <option value="Inactive" @if (old('status', $duty->status) == 'Inactive') selected @endif>
                                            🔴 Inactive
                                        </option>
                                    </select>
                                ...
                                <div
                                    ...
                                    <div>
                                        <div class="flex items-center mb-2">
                                            ...
                                            <span class="text-sm text-gray-600 ml-2">Select activities exempt from PT,
                                                Games,
                                        ...
                                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                            <div class="flex items-start space-x-3">
                                                <input type="checkbox" id="excused-next-day-pt"
                                                    ...
                                                    class="w-5 h-5 text-blue-600 border-gray-300 rounded focus:ring-blue-500"
                                                    {{ old('excused_next_session_pt', $duty->excused_next_session_pt) ? 'checked' : '' }}>
                                            ...
                                            <div class="flex items-start space-x-3">
                                                <input type="checkbox" id="excused-next-day-games"
                                                    ...
                                                    class="w-5 h-5 text-blue-600 border-gray-300 rounded focus:ring-blue-500"
                                                    {{ old('excused_next_session_games', $duty->excused_next_session_games) ? 'checked' : '' }}>
                                            ...
                                            <div class="flex items-start space-x-3">
                                                <input type="checkbox" id="excused-next-day-roll-call"
                                                    ...
                                                    class="w-5 h-5 text-blue-600 border-gray-300 rounded focus:ring-blue-500"
                                                    {{ old('excused_next_session_roll_call', $duty->excused_next_session_roll_call) ? 'checked' : '' }}>
                                                <label for="excused-next-day-roll-call" class="text-sm text-gray-700">
                                                    Roll Call
                                                    ({{ $siteSettings->roll_call_time->format('H:i') ?? 'N/A' }})
                                                </label>
                                            </div>
                                            <div class="flex items-start space-x-3">
                                                <input type="checkbox" id="excused-next-day-parade"
                                                    ...
                                                    class="w-5 h-5 text-blue-600 border-gray-300 rounded focus:ring-blue-500"
                                                    {{ old('excused_next_session_parade', $duty->excused_next_session_parade) ? 'checked' : '' }}>
