                                        ...
                                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                            <div class="flex items-start space-x-3">
                                                <input type="checkbox" id="excused-next-day-pt"
                                                    name="excused_next_day_pt" value="1"
                                                    class="w-5 h-5 text-blue-600 border-gray-300 rounded focus:ring-blue-500"
                                                    {{ old('excused_next_day_pt', $duty->excused_next_day_pt) ? 'checked' : '' }}>
                                            ...
                                            <div class="flex items-start space-x-3">
                                                <input type="checkbox" id="excused-next-day-games"
                                                    ...
                                                    class="w-5 h-5 text-blue-600 border-gray-300 rounded focus:ring-blue-500"
                                                    {{ old('excused_next_day_games', $duty->excused_next_day_games) ? 'checked' : '' }}>
                                            ...
                                            <div class="flex items-start space-x-3">
                                                <input type="checkbox" id="excused-next-day-roll-call"
                                                    ...
                                                    class="w-5 h-5 text-blue-600 border-gray-300 rounded focus:ring-blue-500"
                                                    {{ old('excused_next_day_roll_call', $duty->excused_next_day_roll_call) ? 'checked' : '' }}>
                                            ...
                                            <div class="flex items-start space-x-3">
                                                <input type="checkbox" id="excused-next-day-parade"
                                                    ...
                                                    class="w-5 h-5 text-blue-600 border-gray-300 rounded focus:ring-blue-500"
                                                    {{ old('excused_next_day_parade', $duty->excused_next_day_parade) ? 'checked' : '' }}>
