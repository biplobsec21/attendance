        ...
        <div class="bg-white/30 shadow-lg rounded-lg p-6 formBack w-full max-w-lg mx-auto">
            ...
            <form method="POST" action="{{ route('duty.update', $duty->id) }}">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="duty-name" name="duty_name" value="{{ old('duty_name', $duty->duty_name) }}"
                ...
                {{-- <div class="mb-4">
                    <label for="manpower" class="block text-gray-700 text-sm font-bold mb-2">Manpower <span
                            class="text-red-600">*</span></label>
                    <input type="number" id="manpower" name="manpower" value="{{ old('manpower', $duty->manpower) }}"
                        min="1"
                ...
                <div class="mb-4">
                    ...
                    <textarea id="remark" name="remark"
                        ...
                        placeholder="Enter any remarks..." rows="3">{{ old('remark', $duty->remark) }}</textarea>
                    @error('remark')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                </div>
