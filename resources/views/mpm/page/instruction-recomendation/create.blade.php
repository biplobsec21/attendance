...
@section('title', 'Create Instruction Recommendation')
...
@section('content')
    <div class="container mx-auto p-4">
        ...
        <div class="bg-white/30 shadow-lg rounded-lg p-6 formBack w-full max-w-lg mx-auto">
            <h1 class="text-2xl font-bold mb-6 text-center text-gray-800">Create New Instruction Recommendation</h1>

            <form method="POST" action="{{ route('instruction-recomendations.store') }}"
                ...
                <div class="mb-4">
                    ...
                    <textarea id="description" name="description" rows="3"
                        ...
                        placeholder="Enter recommendation description">{{ old('description') }}</textarea>
                    @error('description')
                        <p class="text-red-500 text-xs italic mt-1">{{ $message }}</p>
                    @enderror
                </div>
